...
export const metadata = {
  title: 'Hoang Huynh | Personal Portfolio',
  description: 'Hoang Huynh is a Frontend devloper Fullstack orientation.',
}
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      ...
      >
        ...
        h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] sm:left-[-35rem] md:left-[-33rem] 
        lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] -z-10 dark:bg-[#676394]'></div>
